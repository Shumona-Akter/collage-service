...
const Banner = () => {
  ...
  <div id="slide1" className="carousel-item relative w-full">
    ...
    <div className="absolute w-1/2 justify-center transform -translate-x-1/2 left-1/2 top-1/2">
        <div className="flex">
        <input className="w-full mx-auto p-2 rounded-md mr-4 capitalize" type="text" placeholder="Search your Collage"/>
